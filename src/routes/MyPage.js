    ...
    return (
        ...
        <div className="myPageContainer">
            ...
            <div className="leftContent">
                <h4 style={{ fontWeight:'bold', marginLeft:'30px'}}>마이페이지</h4> <br/>

                
                
                <ul style={{listStyleType: 'none'}} >
                    <h5 className="headLine" style={{fontWeight:'bold', marginBottom: '15px'}}>내 정보</h5>
                    <li><Link to="/myPage">프로필 정보</Link></li>
                    <li>주소록</li>
                    <li>결제 정보</li>
                </ul>
                ...
                <ul style={{listStyleType: 'none'}} >
                    <h5 style={{fontWeight:'bold', marginBottom: '15px'}} >쇼핑 정보</h5>
                    <li>구매 내역</li>
                    <li>관심 상품</li>
                </ul>
            </div>
            ...
            <div className="rightContent">
                ...
                <div className="myPageSection1"> 
                    ...
                    <img src={image} alt="Description" style={{width: '100px', height: '100px',borderRadius: '50%'}} />
                    </button>
                    </div>

                    {/* 이름 부분 */}
                    <div>
                        <span style={{fontWeight:'bold', fontSize:'26px', display: 'inline-block', marginBottom: '10px'}}>
                            {user.name} 님</span><br/>
                        <input 
                            type="file" 
                            accept="image/*" 
                        ...
                        <label htmlFor="imageUpload" className="btn" style={{fontSize:'12px', cursor: 'pointer'}}>
                            이미지 변경
                        </label>
                        <button className="btn" style={{fontSize:'12px', marginLeft:'15px'}} onClick={()=> {console.log(image)}}> 삭제</button>
                    </div>
                </div>
                ...
                <div className="myPageSection2">
                    ...
                    <div className="list">
                        <div><label>비밀번호</label><br/>
                        <span>●●●●●●●</span></div>
                        <button className="btn" type="button">변경</button>
                    </div>
